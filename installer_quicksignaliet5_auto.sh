...
#
# Example run:
# wget -qO- "https://raw.githubusercontent.com/Saiedf/QuickSignalIet5/main/installer_quicksignaliet5_auto.sh" | /bin/sh
#
# Alternative:
# wget -O /tmp/installer_quicksignaliet5_auto.sh "https://raw.githubusercontent.com/Saiedf/QuickSignalIet5/main/installer_quicksignaliet5_auto.sh" && chmod 755 /tmp/installer_quicksignaliet5_auto.sh && /bin/sh /tmp/installer_quicksignaliet5_auto.sh
# ==========================================================

PACKAGE_NAME='enigma2-plugin-extensions-quicksignaliet5'
LEGACY_PACKAGE_NAME='enigma2-plugin-extensions-QuickSignalIet5'
PLUGIN_TITLE='QuickSignalIet5'
PLUGIN_FOLDER='QuickSignalIet5'

REPO_USER='Saiedf'
REPO_NAME='QuickSignalIet5'
REPO_BRANCH='main'
